...
namespace DAn_QLCuaHangBanthuoc
{
    public partial class frm_staff : Form
    {
        ...
        void LoadData()
        {
            ...
            {
                dgv_data.Rows.Add(row[0], row[1], row[2], row[5], row[4], row[3], row[6], row[7], row[8], row[9], row[10]);
            }
        }
        ...
        private void dgv_data_DoubleClick(object sender, EventArgs e)
        {
            if (dgv_data.Rows.Count > 0)
            {
                ...
                frm_add_staff form = new frm_add_staff(1, selectedID);
                form.ShowDialog();
                LoadData();
            }
        }
        ...
        {
            frm_add_staff frm = new frm_add_staff(0);
            frm.ShowDialog();
            LoadData();
        }
